<nav x-data="{ open: false }" class="bg-primary-800 border-b-2 border-accent-orange">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 group">
                        <svg class="w-8 h-8 fill-accent-orange group-hover:fill-accent-lightOrange transition-colors duration-200" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-xl font-bold text-accent-orange group-hover:text-accent-lightOrange transition-colors duration-200">
                            Critical Dice
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('character.selector') }}" :active="request()->routeIs('character.*')">
                        Personajes
                    </x-nav-link>
                </div>
            </div>
